...
from .input_policy import UtgBasedInputPolicy, UtgNaiveSearchPolicy, UtgGreedySearchPolicy, \
                         ...
                         POLICY_REPLAY, POLICY_MEMORY_GUIDED, POLICY_LLM_GUIDED, POLICY_MIXED_GUIDED, \
...
class InputManager(object):
    ...
    def get_input_policy(self, device, app, master):
        ...
        elif self.policy_name == POLICY_MIXED_GUIDED:
            from .input_policy4 import Mixed_Guided_Policy
            input_policy = Mixed_Guided_Policy(device, app, self.random_input)
